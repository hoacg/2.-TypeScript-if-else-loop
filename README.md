...
* Bước 3: Mở file src/control-flow.ts trong project vừa tạo, sau đó code lần lượt các đoạn code sau:
* Bước 4: Chạy để kiểm tra kết quả đạt được bằng lệnh “tsc src/control-flow.ts”
